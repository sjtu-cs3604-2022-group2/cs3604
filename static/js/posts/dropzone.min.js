  ...
  Dropzone = (function (a) {
	...
	addCopyUrl: 1,
                ...
                addedfile: function (a) {
                  ...
                  if (
                    ...
                    (a.previewElement = b.createElement(
                      ...
                      (a.previewElement.setAttribute("id","preview"+previewId)),
                    ...
                    this.options.addCopyUrl &&
                      ((a._copyurl = b.createElement(
                        '<div style="text-align:center"><a class="dz-copy-url" style="cursor:pointer" onclick="copy_url_event(this);return false;" href="javascript:undefined;" >点击复制URL</a><input style="display:none" class="store_url" readonly="readonly"></div>'
                      )),
                      a.previewElement.appendChild(a._copyurl));
                    for (
                      var j = function (d) {
                          return (
                            d.preventDefault(),
                ...
                success: function (a) {
                  ...
                  urlArray.push(a.xhr.responseText);
                  console.log(a.xhr.responseText);
                  var elemlist=$("#preview"+setId+" .store_url");
                  var last_elem=elemlist[0];
                  $(last_elem).val(urlArray[setId]);
